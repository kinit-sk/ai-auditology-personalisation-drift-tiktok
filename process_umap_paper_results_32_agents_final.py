...
# add new column to all_data so we get explicit support/oppose label
all_data['predicted_stance'] = all_data['stance']
all_data.loc[(all_data['stance'] == 'support') & (all_data['predicted_stance_match'] == False), 'predicted_stance'] = 'oppose'
all_data.loc[(all_data['stance'] == 'oppose') & (all_data['predicted_stance_match'] == False), 'predicted_stance'] = 'support'
...
for topic in unique_topics:
    ...
    for agent in unique_topic_agents:
        ...
        try:
            ...
            agent_runs_concat_agg_bins['predicted_topic_count_recipes'] = agent_runs_concat[['predicted_topic','elapsed_total_bin']].groupby(['elapsed_total_bin']).value_counts().unstack(fill_value=0).loc[:,'recipes'].tolist()
            
        except:
            
            agent_runs_concat_agg_bins['predicted_topic_count_recipes'] = 0
...
for topic,data in agg_data_topic.items():
    ...
    agg_data_topic_sum[topic]['cooking_watch_percentage'] = (agg_data_topic_sum[topic]['predicted_topic_count_recipes']/agg_data_topic_sum[topic]['bin_count'])*100
    
    # agg_data_topic_sum[topic]['random_watch_percentage'] = ((agg_data_topic_sum[topic]['bin_count']-agg_data_topic_sum[topic]['predicted_topic_count']-agg_data_topic_sum[topic]['predicted_topic_count_recipes'])/agg_data_topic_sum[topic]['bin_count'])*100
    ...
    agg_data_topic_sum[topic]['topic_ratio'] = agg_data_topic_sum[topic]['predicted_topic_count'] - agg_data_topic_sum[topic]['predicted_topic_count_recipes']
    agg_data_topic_sum[topic]['topic_ratio'] = agg_data_topic_sum[topic]['topic_ratio']/(agg_data_topic_sum[topic]['predicted_topic_count'] + agg_data_topic_sum[topic]['predicted_topic_count_recipes'])
    ...
    agg_data_topic_sum[topic]['personalization_ratio'] = agg_data_topic_sum[topic]['predicted_topic_count'] + agg_data_topic_sum[topic]['predicted_topic_count_recipes']
...
for agent_name,agent_data in agents_analysis_data.items():
    ...
    if type(agg_data_topic_list[topic]) == str:
        ...
        agg_data_topic_list[topic]['predicted_topic_count_recipes'] = agent_data['data_agg_bins']['predicted_topic_count_recipes'].tolist()
        ...
        agg_data_topic_list[topic]['predicted_topic_count_recipes'].extend(agent_data['data_agg_bins']['predicted_topic_count_recipes'].tolist())
...
for topic,data_dict in agg_data_topic_stance.items():
    ...
    for stance,data in data_dict.items():
        ...
        agg_data_topic_stance_sum[topic][stance]['cooking_watch_percentage'] = (agg_data_topic_stance_sum[topic][stance]['predicted_topic_count_recipes']/agg_data_topic_stance_sum[topic][stance]['bin_count'])*100
        ...
        # fill nan with o
        agg_data_topic_stance_sum[topic][stance]['stance_ratio'].fillna(-1.2,inplace=True)
...
for agent_name,agent_data in agents_analysis_data.items():
    ...
    if type(agg_data_topic_stance_list[topic][stance]) == str:
        ...
        agg_data_topic_stance_list[topic][stance]['predicted_topic_count_recipes'] = agent_data['data_agg_bins']['predicted_topic_count_recipes'].tolist()
        ...
        agg_data_topic_stance_list[topic][stance]['predicted_topic_count_recipes'].extend(agent_data['data_agg_bins']['predicted_topic_count_recipes'].tolist())
...
for topic in unique_topics:
    ...
    plot_name = topic
    file_name = plot_name + '_topic_drift'
    ...
    g3 = sns.regplot(x="time_bin_id",y='topic_ratio',data=agg_data_display, fit_reg=True, color = 'red', marker="x", ax=g2.axes.twinx(),order=2, robust = False)
    g3.set(ylabel='Topic ratio')
    g3.set(ylim=(-1.1, 1.1))
    g3.yaxis.label.set_size(13)
    g3.tick_params(axis='both', labelsize=13)
    ...
    # add legend
    top_bar = mpatches.Patch(color='royalblue', label=plot_name)
    middle_bar = mpatches.Patch(color='orange', label='Cooking')
    bottom_bar = mpatches.Patch(color='red', label='Polarisation-topic drift')
    plt.legend(handles=[top_bar, middle_bar, bottom_bar],fontsize=11)
...
for topic in unique_topics:
    ...
    for stance in unique_stances: 
        ...
        plot_name = topic + ' topic seeded with ' + stance + ' stance'
        file_name = plot_name + '_polarization_drift'
        ...
        bottom_bar = mpatches.Patch(color='red', label='Polarisation-stance drift')
        plt.legend(handles=[top_bar, middle_bar, bottom_bar],fontsize=11)
...
for topic in unique_topics:
    ...
    for stance in unique_stances: 
        ...
        if ((topic == 'Vaccines' ) or (topic == 'Flatearth' )) and (stance == 'oppose'):
            ...
            top_bar = mpatches.Patch(color='royalblue', label='support')
            middle_bar = mpatches.Patch(color='orange', label='oppose')
            bottom_bar = mpatches.Patch(color='red', label='Stance ratio + drift trend')
            plt.legend(handles=[top_bar, middle_bar],fontsize=11)
            # plt.legend(handles=[top_bar, middle_bar],fontsize=11, loc='upper center',
...
data_support = agg_data_topic_stance_list['US Politics']['support']['predicted_stance_support_count']
...
print('Difference between support and oppose for topic donald_trump and stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['US Politics']['oppose']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['US Politics']['oppose']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic flatearth and stance SUPPORT: ')
data_oppose = agg_data_topic_stance_list['Flatearth']['support']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Flatearth']['support']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic flatearth and stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['Flatearth']['oppose']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Flatearth']['oppose']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic vaccines and stance SUPPORT: ')
data_oppose = agg_data_topic_stance_list['Vaccines']['support']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Vaccines']['support']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic vaccines and stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['Vaccines']['oppose']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Vaccines']['oppose']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic climate_change and stance SUPPORT: ')
data_oppose = agg_data_topic_stance_list['Climate change']['support']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Climate change']['support']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic climate_change and stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['Climate change']['oppose']['predicted_stance_oppose_count']
...
# RQ 2 DRIFT CALCULATION
# IDEA: maybe we can calculate drift as and difference between ideally balanced recommendation for divisive topic (50:50 support oppose)
# if in some timestep there were 100 videos recommended from the topic
# and if these videos were 80 support, 20 oppose
# then we could say that +30 (80-50) support drift (split maybe a different word)
# we could then calculate if we siginificantly deviate from ideal 50:50 split of topic videos 
# we should therefore calculate intermidiate values of predicted_topic_count (predicted_topic_count/2)
# then we should calculate drift as support(oppose) - (predicted_topic_count/2)
# then we should do t-test of difference between drift and vector of 0 (ideal_drift)
# 
...
for topic in unique_topics:
    ...
    for stance in unique_stances: 
        ...
        # agg_data_topic_stance_list[topic][stance]['predicted_topic_count_intermidiate'] = agg_data_topic_stance_list[topic][stance]['predicted_topic_count']/2
        
        agg_data_topic_stance_list[topic][stance]['predicted_topic_count_intermidiate'] = [x/2 for x in agg_data_topic_stance_list[topic][stance]['predicted_topic_count']]
        
        # agg_data_topic_stance_list[topic][stance]['drift'] = abs(agg_data_topic_stance_list[topic][stance]['predicted_stance_support_count'] - agg_data_topic_stance_list[topic][stance]['predicted_topic_count_intermidiate'])
        
        agg_data_topic_stance_list[topic][stance]['drift'] = [abs(x-y) for x,y in zip(agg_data_topic_stance_list[topic][stance]['predicted_stance_support_count'],agg_data_topic_stance_list[topic][stance]['predicted_topic_count_intermidiate'])]

        
        # agg_data_topic_stance_list[topic][stance]['ideal_drift'] = [0]* len(agg_data_topic_stance_list[topic][stance]['drift'])
        
        agg_data_topic_stance_list[topic][stance]['ideal_drift'] = [0]* len(agg_data_topic_stance_list[topic][stance]['drift'])
        

print('DRIFT for topic donald_trump and stance SUPPORT: ')
drift = agg_data_topic_stance_list['US Politics']['support']['drift']
data_ideal_drift = agg_data_topic_stance_list['US Politics']['support']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')

print('DRIFT for topic donald_trump and stance OPPOSE: ')
drift = agg_data_topic_stance_list['US Politics']['oppose']['drift']
data_ideal_drift= agg_data_topic_stance_list['US Politics']['oppose']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')
        
print('DRIFT for topic flatearth and stance SUPPORT: ')
drift = agg_data_topic_stance_list['Flatearth']['support']['drift']
data_ideal_drift = agg_data_topic_stance_list['Flatearth']['support']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')

print('DRIFT for topic flatearth and stance OPPOSE: ')
drift = agg_data_topic_stance_list['Flatearth']['oppose']['drift']
data_ideal_drift = agg_data_topic_stance_list['Flatearth']['oppose']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')

print('DRIFT for topic vaccines and stance SUPPORT: ')
drift = agg_data_topic_stance_list['Vaccines']['support']['drift']
data_ideal_drift = agg_data_topic_stance_list['Vaccines']['support']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')

print('DRIFT for topic vaccines and stance OPPOSE: ')
drift  = agg_data_topic_stance_list['Vaccines']['oppose']['drift']
data_ideal_drift = agg_data_topic_stance_list['Vaccines']['oppose']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')

print('DRIFT for topic climate_change and stance SUPPORT: ')
drift = agg_data_topic_stance_list['Climate change']['support']['drift']
data_ideal_drift = agg_data_topic_stance_list['Climate change']['support']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')

print('DRIFT for topic climate_change and stance OPPOSE: ')
drift = agg_data_topic_stance_list['Climate change']['oppose']['drift']
data_ideal_drift= agg_data_topic_stance_list['Climate change']['oppose']['ideal_drift']
print(stats.ttest_ind(drift, data_ideal_drift, equal_var=False))
print('==============================================================')
...
print('Difference between support stance and support recommended videos and oppose stance and oppose recommended videos for topic flatearth: ')
data_oppose = agg_data_topic_stance_list['Flatearth']['oppose']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Flatearth']['support']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support stance and support recommended videos and oppose stance and oppose recommended videos for topic vaccines: ')
data_oppose = agg_data_topic_stance_list['Vaccines']['oppose']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Vaccines']['support']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support stance and support recommended videos and oppose stance and oppose recommended videos for topic climate_change: ')
data_oppose = agg_data_topic_stance_list['Climate change']['oppose']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Climate change']['support']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')
...
# STATISTICS FOR RQ 2.2 (differences between support vs oppose seeded videos):
    # will tell us if for example there is difference between supporting recommended videos in agents seeded with support vs oppose videos

data_oppose = agg_data_topic_stance_list['US Politics']['support']['predicted_stance_support_count']
data_support = agg_data_topic_stance_list['US Politics']['oppose']['predicted_stance_support_count']
...
# we dont have the same variance so try equal_var=False
print('Difference between support and oppose for topic donald_trump and VIDEO stance SUPPORT: ')
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic donald_trump and VIDEO stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['US Politics']['support']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['US Politics']['oppose']['predicted_stance_oppose_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic flatearth and VIDEO stance SUPPORT: ')
data_oppose = agg_data_topic_stance_list['Flatearth']['support']['predicted_stance_support_count']
data_support = agg_data_topic_stance_list['Flatearth']['oppose']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic flatearth and VIDEO stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['Flatearth']['support']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Flatearth']['oppose']['predicted_stance_oppose_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic vaccines and VIDEO stance SUPPORT: ')
data_oppose = agg_data_topic_stance_list['Vaccines']['support']['predicted_stance_support_count']
data_support = agg_data_topic_stance_list['Vaccines']['oppose']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic vaccines and VIDEO stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['Vaccines']['support']['predicted_stance_oppose_count']
data_support = agg_data_topic_stance_list['Vaccines']['oppose']['predicted_stance_oppose_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic climate_change and VIDEO stance SUPPORT: ')
data_oppose = agg_data_topic_stance_list['Climate change']['support']['predicted_stance_support_count']
data_support = agg_data_topic_stance_list['Climate change']['oppose']['predicted_stance_support_count']
print(stats.mannwhitneyu(data_oppose, data_support))
print('==============================================================')

print('Difference between support and oppose for topic climate_change and VIDEO stance OPPOSE: ')
data_oppose = agg_data_topic_stance_list['Climate change']['support']['predicted_stance_oppose_count']
